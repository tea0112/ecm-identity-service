...
/**
 * Database connectivity test using @DataJpaTest to avoid full Spring Boot context loading.
 * This test focuses only on JPA repositories and database connectivity.
 */
@DataJpaTest
@Testcontainers
